...
export default function HeroVideoBlock({ block }: HeroVideoBlockProps) {
  ...
  return (
    <section
      className={
        isHome
          ? 'relative h-screen min-h-[600px] flex items-end overflow-hidden'
          : 'relative h-[55vh] min-h-[420px] max-h-[640px] flex items-end overflow-hidden'
      }
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pb-20 w-full">
        ...
        <h1
          className={
            isHome
              ? 'font-display text-white text-6xl sm:text-7xl lg:text-9xl leading-none mb-6 max-w-4xl'
              : 'font-display text-white text-5xl sm:text-6xl lg:text-7xl leading-none mb-4 max-w-3xl'
          }
        >
          {heading}
        </h1>
        {subheading && (
          <p
            className={
              isHome
                ? 'text-white/70 text-base lg:text-lg max-w-xl mb-10 leading-relaxed'
                : 'text-white/70 text-sm lg:text-base max-w-lg mb-6 leading-relaxed'
            }
          >
            {subheading}
          </p>
